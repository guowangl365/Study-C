...
int main(void)
{
	...
	PWM_IO_Config();
	TIM_Config(998/2,998*3/10);
	GPIO_Configuration();     
  LCD1602_Init();
//  LED_Config();
//	LCD1602_Show_Str(20,0,"TIMER DEMO");
//		//OLED_P16x16Str(0+8,2,"湖工计算机学院");
//	  LCD1602_Show_Str(0,2," TIM2 PWM MODE ");	
		LCD1602_Show_Str(0,0,"PORTA.1-PWM:50%");		
		LCD1602_Show_Str(0,4,"PORTA.2-PWM:70%");		
	while(1)
	{
