...
int main(void)
{
  ...
  LED_Config();
	 ...
	 OLED_P8x16Str(0,0,"KEY EXTI DEMO");
	OLED_P8x16Str(0,2,"Press the button");
...
//				LCD_DisplayStringLine(Line7," Button1 pressed...");
			    OLED_P8x16Str(0,4,"Button1 pressed");
				break;
			case 2:
//				LCD_DisplayStringLine(Line7," Button2 pressed...");
				OLED_P8x16Str(0,4,"Button2 pressed");
		  	break;
			case 3:
//				LCD_DisplayStringLine(Line7," Button3 pressed...");
			   OLED_P8x16Str(0,4,"Button3 pressed");
				break;
			case 4:
//				LCD_DisplayStringLine(Line7," Button4 pressed...");
			   OLED_P8x16Str(0,4,"Button4 pressed");
				break;
